        ...
        <div class="row g-5">
                ...
                <div class="row g-3">
                    <div class="col-6 text-end">
                        <img class="img-fluid bg-white w-100 mb-3 wow fadeIn" data-wow-delay="0.1s"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-1.jpg" alt="">
                        <img class="img-fluid bg-white w-50 wow fadeIn" data-wow-delay="0.2s"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-3.jpg" alt="">
                    </div>
                    <div class="col-6">
                        <img class="img-fluid bg-white w-50 mb-3 wow fadeIn" data-wow-delay="0.3s"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-4.jpg" alt="">
                        <img class="img-fluid bg-white w-100 wow fadeIn" data-wow-delay="0.4s"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-2.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-4">
                        <img class="img-fluid bg-white w-100"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-5.jpg" alt="">
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-4">
                        <img class="img-fluid bg-white w-100"
                            src="<?= base_url('assets-landingpage/'); ?>img/about-6.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container py-5">
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.5s">
            <div class="testimonial-item p-4 p-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0"
                        src="<?= base_url('assets-landingpage/'); ?>img/testimonial-1.jpg" alt="">
            ...
            <div class="testimonial-item p-4 p-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0"
                        src="<?= base_url('assets-landingpage/'); ?>img/testimonial-2.jpg" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
            ...
            <div class="testimonial-item p-4 p-lg-5">
                ...
                <div class="d-flex align-items-center justify-content-center">
                    <img class="img-fluid flex-shrink-0"
                        src="<?= base_url('assets-landingpage/'); ?>img/testimonial-3.jpg" alt="">
                    <div class="text-start ms-3">
                        <h5>Client Name</h5>
                        <span class="text-primary">Profession</span>
                    </div>
