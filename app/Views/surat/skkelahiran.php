                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data SK Kelahiran</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($surat as $p) : ?>
                                        <tr>
                                            ...
                                            <td><?= $p['nama_anak']; ?></td>
                                            <td><?= $p['kelamin_anak']; ?></td>
                                            <td><?= $p['anak_ke']; ?></td>
                                            <td><?= $p['hubungan_dengan_bayi']; ?></td>
                                            <td><?= $p['datetime_kelahiran']?><br><?= $p['tempat_lahir_anak']; ?></td>
                                            <td>
                                                <form action="<?= base_url('/pelayanan/update_status/' . $p['id_skk']); ?>" method="post" class="status-form" style="display:inline;">
                                                    <?= csrf_field(); ?>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-info" data-toggle="modal" data-target="#detailModal<?= $p['id_skk']; ?>">Lihat Detail</button>

                                                <!-- Modal -->
                                                <div class="modal fade" id="detailModal<?= $p['id_skk']; ?>" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel<?= $p['id_skk']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="detailModalLabel<?= $p['id_skk']; ?>">Detail Persyaratan dan Foto</h5>
